...
ghcMetrics =
  GHCMetrics
    (counter $ Info "ghc_gcs_total" "Total number of GCs")
    (counter $ Info "ghc_major_gcs_total" "Total number of major (oldest generation) GCs")
    (counter $ Info "ghc_allocated_bytes_total" "Total bytes allocated")
    (gauge   $ Info "ghc_max_live_bytes" "Maximum live data (including large objects + compact regions)")
    (gauge   $ Info "ghc_max_large_objects_bytes" "Maximum live data in large objects")
    (gauge   $ Info "ghc_max_compact_bytes" "Maximum live data in compact regions")
    (gauge   $ Info "ghc_max_slop_bytes" "Maximum slop")
    (gauge   $ Info "ghc_max_mem_in_use_bytes" "Maximum memory in use by the RTS")
    (counter $ Info "ghc_cumulative_live_bytes_total" "Sum of live bytes across all major GCs. Divided by major_gcs gives the average live data over the lifetime of the program.")
    (counter $ Info "ghc_copied_bytes_total" "Sum of copied_bytes across all GCs")
    (counter $ Info "ghc_par_copied_bytes_total" "Sum of copied_bytes across all parallel GCs")
    (counter $ Info "ghc_cumulative_par_max_copied_bytes_total" "Sum of par_max_copied_bytes across all parallel GCs")
    (counter $ Info "ghc_mutator_cpu_seconds_total" "Total CPU time used by the mutator")
    (counter $ Info "ghc_mutator_elapsed_seconds_total" "Total elapsed time used by the mutator")
    (counter $ Info "ghc_gc_cpu_seconds_total" "Total CPU time used by the GC")
    (counter $ Info "ghc_gc_elapsed_seconds_total" "Total elapsed time used by the GC")
    (counter $ Info "ghc_cpu_seconds_total" "Total CPU time (at the previous GC)")
    (counter $ Info "ghc_elapsed_seconds_total" "Total elapsed time (at the previous GC)")
    (gauge   $ Info "ghc_gcdetails_gen" "The generation number of this GC")
    (gauge   $ Info "ghc_gcdetails_threads" "Number of threads used in this GC")
    (gauge   $ Info "ghc_gcdetails_allocated_bytes" "Number of bytes allocated since the previous GC")
    (gauge   $ Info "ghc_gcdetails_live_bytes" "Total amount of live data in the heap (including large + compact data)")
    (gauge   $ Info "ghc_gcdetails_large_objects_bytes" "Total amount of live data in large objects")
    (gauge   $ Info "ghc_gcdetails_compact_bytes" "Total amount of live data in compact regions")
    (gauge   $ Info "ghc_gcdetails_slop_bytes" "Total amount of slop (wasted memory)")
    (counter $ Info "ghc_gcdetails_mem_in_use_bytes" "Total amount of memory in use by the RTS")
    (gauge   $ Info "ghc_gcdetails_copied_bytes" "Total amount of data copied during this GC")
    (gauge   $ Info "ghc_gcdetails_par_max_copied_bytes" "In parallel GC, the max amount of data copied by any one thread")
    (gauge   $ Info "ghc_gcdetails_sync_elapsed_seconds" "The time elapsed during synchronisation before GC")
    (gauge   $ Info "ghc_gcdetails_cpu_seconds" "The CPU time used during GC itself")
    (gauge   $ Info "ghc_gcdetails_elapsed_seconds" "The time elapsed during GC itself")
